...
if($request == "datatable"){
    ...
    while ($row = mysqli_fetch_assoc($empRecords)) {
       ...
       // Update Button
       $updateButton = '<div class="col-6 col-sm-12 col-md-12 col-xl py-3"><button type="button" class="btn btn-ghost-info active w-100 update" id="update" data-id="'.$row['id'].'"  data-bs-toggle="modal" data-bs-target="#modal-update">Modifier</button></div>';

       // Delete Button
       $deleteButton = '<div class="col-6 col-sm-12 col-md-12 col-xl py-3">
